...
json_lang_en = {
    ...
    "administration_tempban_already_banned": "{} is already banned in this server.",
    ...
    "command_binfo_help": "Server bot latency is directly tied to which shard the target server is placed in.",
    ...
    "command_blacklist_help": "This command can only be used by server **administrators**.",
    ...
    "command_goodbye_test_help": "This command can only be used by server **administrators**.",
    ...
    "command_greetings_test_help": "This command can only be used by server **administrators**.",
    ...
    "command_langset_help": "This command can only be used by server **administrators**.",
    ...
    "command_leveling_help": "This command can only be used by **server administrators**",
    "command_leveling_reset_description": "Resets experience and level progression for all users on your server back to 0.",
    "command_leveling_reset_help": "This command can only be used by **server owners**",
    ...
    "command_slowmode_help": "- This command accepts the following time units: `s(econds), m(inutes), h(ours)`\n- This command can only be used by users with the ability to **manage messages** and **manage channels**.",
    ...
    "command_tempban_description": "Temporarily bans the mentioned invidivual for a specified amount of time for a certain reason (if any).",
    "command_tempban_help": "- This command accepts the following time units: `m(inutes), h(ours), d(ays), w(eeks)`\n- This command can only be used by users with the ability to **ban** members.",
    "command_tempmute_description": "Temporarily mutes the target individual from chatting on the server.",
    "command_tempmute_help": "- This command accepts the following time units: `m(inutes), h(ours), d(ays), w(eeks)`\n- This command can only be used by users with the ability to **manage messages**.",
    ...
    "conquest_leave_confirmation": "Please type **'yes'** or **'no'** to confirm whether you want to leave your current settlement.",
    ...
    "core_cmds_list_empty": "Either this module ({}) does not have any commands or all of them are hidden.",
    ...
    "core_module_disable_dependencies": "This module cannot be disabled as it depends on the following currently enabled modules: *{}*",
    ...
    "economy_daily_claimed": "You already claimed your daily reward! The next daily reward available in {} hour(s) {} minute(s) and {} second(s).",
    ...
    "utility_binfo_guilds": "Servers:",
    "utility_binfo_latency": "Shard latency:",
    "utility_binfo_owner": "Owner:",
    "utility_binfo_title": "Bot Information",
    "utility_binfo_uptime": "Uptime:",
    "utility_binfo_uptime_format": "\u2022 {} {}, {} {} and {} {}",
    "utility_binfo_users": "Users:",
