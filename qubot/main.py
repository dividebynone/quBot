...
json_lang_en = {
    ...
    "profiles_levelrole_dashboard_desc": "This is an overview of all roles that can be received in this server by leveling up. They can be changed at any given time using the corresponding command, which can be found using the bot's help command.",
    "profiles_levelrole_dashboard_empty": "No leveling role rewards are set up on this server",
    "profiles_levelrole_dashboard_header": "Leveling roles for {}",
    "command_levelrole_dashboard_description": "Displays your server's leveling role reward settings.",
    "command_levelrole_remove_description": "Deletes the leveling role reward that corresponds to the provided level",
    "profiles_levelrole_remove_title": "Removed role level reward",
    "profiles_levelrole_remove": "Successfully removed all role rewards tied to level **{}**",
    "profiles_levelrole_title": "New role level reward",
    "profiles_levelrole_desc": "Successfully added the role '{}' as a level **{}** reward.",
    "profiles_levelrole_max_title": "Failed to add role",
    "profiles_levelrole_max": "This server has reached the maximum number of roles allowed to be allocated as leveling rewards: {}",
    "command_levelrole_description": "Sets the target role as a leveling reward for everyone who reaches the specified level.",
    "profile_level_up_message_dm": "Congratulations {}, You've reached level **{}** on the server **'{}'**!",
    "profile_lvlnotify_channel_permissions": "I could not set the leveling notifications location to that channel. I do not have permissions to send messages there and, as a result, notifications will not be displayed.",
    "profile_lvlnotify_change_title": "Changed leveling notifications",
    "profile_lvlnotify_reset_title": "Resetting leveling notifications",
    "profile_lvlnotify_change_channel": "All future user level up notifications will be sent in the following text channel: {}.",
    "profile_lvlnotify_change_dm": "All future user level up notifications will be sent to users' direct messages (DMs).",
    "profile_lvlnotify_reset": "The server's level up notifications have been reset back to default. All future notifications will be sent in the same channel where the user leveled up.",
    "profile_lvlnotify_type": "Notification Type",
    "profile_lvlnotify_desc": "This is an overview of all leveling notification settings for this server. They can be changed at any given time using this command's subcommands, which can be found using the bot's help command.",
    "profile_lvlnotify_header": "Leveling notification type for {}",
    "default_string": "Default",
    "dm_string": "Direct Messages",
    "channel_string": "Channel",
    "command_lvlnotify_channel_description": "Changes the server's leveling notifications location to the specified channel.",
    "command_lvlnotify_dm_description": "Changes the server's leveling notifications location to users' direct messages.",
    "command_lvlnotify_default_description": "Resets the server's leveling notifications location back to default - the channel where the user leveled up.",
    "command_lvlnotify_description": "Displays your server's leveling notification settings.",
    "command_levelrole_reset_description": "Resets all leveling role rewards for your server.",
    "profiles_lvlrole_reset_confirmation": "Do you really want to reset the server's leveling role rewards?\n\nType `yes` or `no` to confirm your decision.",
    "profiles_lvlrole_reset_title": "Resetting role rewards",
    "profiles_lvlrole_reset_desc": "All server role rewards have been successfully reset. Rewards can be readded at any given time.",
    ...
    "profiles_leveling_reset_confirmation_title": "Resetting user experience",
    "profiles_leveling_reset_confirmation": "This action will reset all users' leveling experience progress on this server. This action is irreversible.\n\nType `yes` or `no` to confirm your decision.",
