...
json_lang_en = {
    ...
    "core_module_disable_dependencies": "This module cannot be unloaded as it depends on the following loaded modules: *{}*",
    ...
    "core_module_enable_dependencies": "This module cannot be loaded as it depends on the following modules that need to be enabled first: *{}*",
    ...
    "wait_for_cancelled": "Confirmation has been cancelled by user.",
    "wait_for_timeout": "Failed to respond to command within the given time limit.",
