...
class Utility(commands.Cog):
    ...
    @commands.command(name='botinfo', aliases=['binfo', 'status', 'about'], help=main.lang["command_binfo_help"], description=main.lang["command_binfo_description"], ignore_extra=True)
    async def botinfo(self, ctx):
        ...
        embed = discord.Embed(title=lang["utility_binfo_title"] ,color = self.module_embed_color)
